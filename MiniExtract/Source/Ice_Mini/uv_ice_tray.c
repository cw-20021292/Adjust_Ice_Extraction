...
#define            Bit2_Ice_Tray_1_2_UV_Ice_Off_On_State                  U8IceTrayUvONB.Bit.b2         /* [2025-12-19] CH.PARK 얼음 OFF 시 UV 동작 */
...
void output_ice_tray_uv(void)
{
    ...
    /* [2025-12-19] CH.PARK 얼음 OFF 시 UV 동작 추가 (신규사양) */
    Bit2_Ice_Tray_1_2_UV_Ice_Off_On_State = uv_ice_off_control();

    /* 탱크커버가 하나라도 열렸으면 바로 트레이 UV는 OFF. 250224 CH.PARK */
    Bit0_Ice_Tray_UV_Tank_Open_Off_State = (~bit_uv_tank_input);

    // [2025-12-19] CH.PARK 얼음 OFF 시 UV 동작 추가로 삭제
